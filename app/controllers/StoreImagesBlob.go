...
func SingleUploadImage(c *fiber.Ctx) error {
	...
	accountString := "DY3+F5+OP8HTH6QloogHjKPnxV8Vo/bD8t+ZEPXgfTSHLp8bt8L/ZBsJsHrPp5r2FBzw1o2qoKRr+AStM4Z/1g=="
	containerName := "images-project"

	// กำหนดค่าการรับรองความถูกต้อง
	credential, err := azblob.NewSharedKeyCredential(accountName, accountString)
	if err != nil {
		log.Fatal(err)
	}
